        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {isAdmin ? (
              <div className="space-y-1">
                ...
                <select
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl py-2 px-3 outline-none focus:border-blue-500/50"
                  required
                >
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl py-2 pl-10 pr-3 outline-none focus:border-blue-500/50"
                  required
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-blue-600 hover:bg-blue-500 text-white py-2 rounded-xl font-bold transition-all disabled:opacity-50 mt-4"
            >
                  ...
                  scans.map((scan) => {
                    ...
                    return (
                      <tr key={scan.id} className="border-b border-white/5 hover:bg-white/5 transition-colors group">
                        ...
                        <td className="py-4 text-right font-mono text-blue-400 font-bold">{scan.scan_count.toLocaleString()}</td>
